            ...
            <div className='grid-2-3'>
                {posts && posts.map((post, index) => {
                    if (index == 0) {
                        ...
                        style={{backgroundImage: `url(https://tdfuqxopvbwbxxvlgsvu.supabase.co/storage/v1/object/public/blog_images/${post.user_uuid}/${post.image_url})`, width: '100%',height: '100%', backgroundSize: 'cover', backgroundPosition: 'center'}}>
                ...
                {posts && posts.map((post, index) => {
                   if (index > 0 && index < 4 ) {
                    return <div className='hero-col-2-child' key={post.id}>
